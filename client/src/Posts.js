                ...
                <Modal.Body>
                    <Form>
                        <Form.Group >
                            ...
                            <Form.Control style={{ marginBottom: '1rem' }} placeholder='Updated Position' name='description' value={updatedPost.description ? updatedPost.description : ''} onChange={handleChange} />
